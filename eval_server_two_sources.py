...
async def health():
    return {
        ...
        "defaults": {
            ...
            "gpus_per_model_instance": base.GPUS_PER_MODEL_INSTANCE,
            "model_instances_per_side": base.MODEL_INSTANCES_PER_SIDE,
            "worker_processes": base.MODEL_WORKER_PROCESSES,
